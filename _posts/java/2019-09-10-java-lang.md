...
|**static double ceil(double a)**<br>: 주어진 값을 일의 자리로 올림 반환|double d1 = Math.ceil(10.1);<br>double d2 = Math.ceil(-10.1);
<br>double d3 = Math.ceil(10.0000015);|d1 = 11.0<br>d2 = -10.0<br>d3 = 11.0|
